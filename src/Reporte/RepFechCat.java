 ...
 * 
 */
public class RepFechCat {
    private final String encabezado = "/Imagenes/encabezadoReport.png";
    
    public void verReporte(Object valor, String fecha, String categoria) throws Exception {
        JasperReport repor;
        JasperPrint re;
        JasperViewer view;
        try {
            String path = "src\\Reporte\\RepFechCat.jasper";
            ...
            view.setTitle("Reporte de " + categoria + " del " + fecha);
