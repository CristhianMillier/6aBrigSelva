 ...
 * @telefono 934576998
 */
public class RepFechRanCat {
    private final String encabezado = "/Imagenes/encabezadoReport.png";
    
    public void verReporte(Object valor, String fecInic, String fecFin, String Categoria) throws Exception {
        JasperReport repor;
        JasperPrint re;
        JasperViewer view;
        try {
            String path = "src\\Reporte\\RepFechRanCat.jasper";
            ...
            parametros.put("titulo", "Reporte OPB - Correspondecia " + Categoria);
            
            re = JasperFillManager.fillReport(repor, parametros, ConexionDaoImp.getConexion("default"));
            view = new JasperViewer(re, false);
            view.setTitle("Reporte del " + fecInic + " al " + fecFin + " con Correspondecia " + Categoria);
