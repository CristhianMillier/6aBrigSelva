 ...
 * @telefono 934576998
 */
public class RepFechSecc {
    private final String encabezado = "/Imagenes/encabezadoReport.png";
    
    public void verReporte(Object valor, String fecha, String seccion) throws Exception {
        JasperReport repor;
        JasperPrint re;
        JasperViewer view;
        try {
            String path = "src\\Reporte\\RepFechSecc.jasper";
            ...
            view.setTitle("Reporte de la sección " + seccion + " del " + fecha);
